...
public class SecurityConfig {
	...
	SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
		return http
				...
				.logout(logout -> logout.logoutUrl("/logout").logoutSuccessHandler(successHandler(repository))).build();
	}
	...
	/*
	 * INSERT INTO `client_post_logout_redirect_uris` (`client_id`,
	 * `post_logout_redirect_uris`) VALUES ('3', 'http://127.0.0.1:8081/logged-out')
	 */
}